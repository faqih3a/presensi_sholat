                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        @if($izin->user->role === 'santri' && $izin->user->santri && $izin->user->santri->foto_referensi && file_exists(public_path('storage/santri_fotos/' . $izin->user->santri->foto_referensi)))
