...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-md-end">
        ...
        <form id="filter-form" action="{{ route('santri.dashboard') }}" method="GET" class="no-loader d-none">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-xl-4 col-md-12">
        <div class="card card-stats h-100 p-3">
            <div class="card-body p-0 d-flex align-items-center gap-3">
                @if($user->santri && $user->santri->foto_referensi && \Illuminate\Support\Facades\Storage::disk('public')->exists('santri_fotos/' . $user->santri->foto_referensi))
    ...
    <div class="col-xl-4 col-md-6">
        <div class="card card-stats h-100 p-3">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="text-muted small fw-bold text-uppercase" style="font-size: 0.65rem;">Kehadiran {{ $period == 'day' ? 'Hari Ini' : ($period == 'week' ? 'Minggu Ini' : 'Bulan Ini') }}</div>
    ...
    <div class="col-xl-4 col-md-6">
        <div class="card card-stats h-100 p-3">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="text-muted small fw-bold text-uppercase" style="font-size: 0.65rem;">Alpha {{ $period == 'day' ? 'Hari Ini' : ($period == 'week' ? 'Minggu Ini' : 'Bulan Ini') }}</div>
